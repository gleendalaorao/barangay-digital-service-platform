    ...
    <DashboardShell>
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        {canManageWebsiteContent(session.role) ? (
          <AnnouncementForm action={updateAnnouncement.bind(null, id)} announcement={announcement} mode="edit" barangayId={session.barangayId} cancelHref="/website/announcements" redirectBase="/website/announcements" />
        ) : (
